...
const BugTable = ({ foundUserSub }) => {
  ...
  return (
    ...
    <div className='mb-8'>
      <h1 className="text-4xl font-bold bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">My Issues</h1>
      <p className="text-gray-600 dark:text-gray-400 mt-2">View and manage your assigned issues</p>
    </div>
